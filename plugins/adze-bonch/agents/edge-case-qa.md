...
- Systemic edge case patterns that affect the codebase beyond this task (e.g., "None of the job handlers in this codebase are idempotent")
- Findings that require architectural changes, not just additional tests
- Security vulnerabilities that need immediate attention regardless of the task
